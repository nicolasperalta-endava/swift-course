...
var dictionary = ["name":"Nicolas", "profession": "Developer", "country":"Argentina","city":"Villa Maria"]
...
dictionary.updateValue("USA", forKey: "country")
...
dictionary["city"] = nil
dictionary.removeValue(forKey: "state")
