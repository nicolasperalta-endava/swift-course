...
var classLibraryBooks: [[String]] = students.map{(student)->[String] in student.libraryBooks}
...
var classPets: [String] = students.compactMap{(student)->String? in
    student.pet
}
